  ...
  <div class="wrapper">
                ...
                <form role="form" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="text" name="prod_name" value="<?php if ($prod_name != "") {
                                                                        echo $prod_name;
                                                                      } else {
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="text" name="prod_qty" value="<?php if ($prod_qty != "") {
                                                                        echo $prod_qty;
                                                                      } else {
                                                                      } ?>" class="form-control" id="exampleInputFile" required>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="text" name="prod_tags" value="<?php if ($prod_tags != "") {
                                                                        echo $prod_tags;
                                                                      } else {
                                                                      } ?>" class="form-control" id="exampleInputFile" required>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="number" name="prod_aprice" value="<?php if ($prod_aprice != "") {
                                                                            echo $prod_aprice;
                                                                          } else {
                                                                          } ?>" class="form-control" id="exampleInputFile" required>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="number" name="prod_price" value="<?php if ($prod_price != "") {
                                                                          echo $prod_price;
                                                                        } else {
                                                                        } ?>" class="form-control" id="exampleInputFile" required>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <select class="form-control" name="prod_type" id="">
                            <option value="<?php if ($prod_type != "") {
                                              echo $prod_type;
                                            } else {
                                            } ?>"><?php if ($prod_type != "") {
                                            echo $prod_type;
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <textarea name="prod_description" value="<?php if ($prod_description != "") {
    ...
    if (isset($_POST['submit'])) {
      ...
      if ($_GET['prod_id'] != "") {
        ...
        $qry = "INSERT INTO `m_product`( `prod_name`,`prod_qty`, `prod_cat_id`, `prod_description`, `prod_tags`,`prod_aprice`,`prod_price`,`prod_type`,`prod_imageone`, `prod_imagetwo`, `prod_imagethree`, `prod_imagefour`, `prod_imagefive`, `prod_status`, `prod_createdat`) VALUES ('$prod_name','$prod_qty','$c_name','$prod_description','$prod_tags','$prod_aprice','$prod_price','$prod_type','$prod_imageone','$prod_imagetwo','$prod_imagethree','$prod_imagefour','$prod_imagefive','Active',CURRENT_TIMESTAMP) ";
        //echo $qry;die;
