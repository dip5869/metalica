...
<!-- ==========================================================
  ...
  <section class="about-page section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="banner-section"><img src="assets/img/about/about%20us.jpg"
                    class="img-fluid  lazyload" alt=""></div>
                </div>
                <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="team-4">
                        <div>
                            <div>
                                <img src="assets/img/1.jpg" class="img-fluid  lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                        ...
                        <div>
                            <div>
                                <img src="assets/img/2.jpg" class="img-fluid  lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="assets/img/3.jpg" class="img-fluid  lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
                        <div>
                            <div>
                                <img src="assets/img/4.jpg" class="img-fluid  lazyload bg-img" alt="">
                            </div>
                            <h4>Hileri Keol</h4>
                            <h6>CEo & Founder At Company</h6>
                        </div>
