                  ...
                  <div id="respond">
                    ...
                    <form id="commentform">
                      ...
                      <p class="comment-form-author">
                        ...
                        <input type="text" id="author" name="author" value="author" size="30" required="required">
                      </p>
                      <p class="comment-form-email">
                        <label for="email">Email <span class="required">*</span></label>
                        <input type="email" id="email" name="email" value="email" aria-required="true" required="required">
                      </p>
                      ...
                      <p class="comment-form-comment">
                        ...
                        <textarea name="comment" id="comment" cols="45" rows="8" aria-required="true" required="required"></textarea>
                      </p>
