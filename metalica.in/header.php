  ...
  <div class="row">
    ...
    <div class="col-sm-6">    
      <form action="#" class="search-form">
        ...
        <div class="aa-search-box">
          <input type="text" name="search" class="search-city-input-box" placeholder="Search products here..">
    ...
    <div class="col-sm-2" style="margin-top: 15px; border-right: 1px solid #fff;">
     <!--  <button class="login-account"><strong>My Account</strong><br/><span>Login/Sign Up</span> </button>
      <div class="panel my-account-dropdown">
        ...
        <div class="dropdown">
    <button class="btn btn-default login-account dropdown-toggle" type="button" data-toggle="dropdown">
    ...
    <div class="col-sm-1" style="margin-top: 30px;">
      <ul class="header-user">
        <li class="">
          <a href="wishlist.php"><i class="fa fa-heart" aria-hidden="true" style="color: #fff;"></i></a>
        </li> 
        <!-- <li class="">
          <a href="javascript:void(0)"  onclick="openSetting()" style="color: #fff;"><i class="fa fa-shopping-cart fa-1x" id="setting-icon" aria-hidden="true" style="color: #fff;"></i></a>
        </li> -->
      </ul>
    </div>
  </div>
    ...
    <div class="setting_box_body">
        <div>
            <div class="sidebar-back">
                <p class="mb-0"> <span class="text-left"> My Cart<span class="" style="color: #218137;"> (5 Items)</span> </span>    
                    <a href="javascript:void(0)" onclick="closeSetting()" class="text-right close-cart">&times;</a></p>
                </div>
            </div>
                ...
                <div class="setting-contant">
                    <div class="row demo-section">
                        ...
                        <div class="col-sm-8 col-12 text-left demo-effects">
                            ...
                            <p class="mb-0 fs-12">  <i class="fa fa-check-circle" aria-hidden="true"></i> <strong>Available in - 500gm</strong></p>
                          ...
                          <span class="plus bg-dark">+</span>
                            ...
                            <p><strong><i class="fa fa-inr" aria-hidden="true"></i>500.99 <i class="fa fa-tag" aria-hidden="true"></i> </strong>
            ...
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <div class="login-help weight--semibold">
                  <div>
                    <div class="login-help weight--semibold text-center">Enter your phone number to</div>
                    <div class="login-help weight--semibold text-center">Login/Sign up</div>
                  </div>
                </div>
                <form>
                  <div class="login-phone">
                    <input type="tel" maxlength="10" class="login-phone__input input" data-test-id="phone-no-text-box" value="">
                  </div>
                  <button disabled="" class="btn weight--semibold login-button btn--gray margin-50" data-test-id="login-next-button">Next
                  </button>
                </form>
              </div>
            </div>
