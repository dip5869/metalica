            ...
            <div class="seq-screen">
             ...
             foreach($run as $c): ?>
                    <li>
                        <div class="seq-model">
                            <img data-seq
                                src="http://localhost/metalic/admin/banner_images/<?php echo $c['b_image']; ?>"
                                alt="Men slide img" />
                        </div>
                    </li>
                    <?php  endforeach; ?>
        ...
        <div class="row">
            ...
            ?>
                        <li class="product-slider">
                            <a href="#"><img
                                    src="http://localhost/metalic/admin/product_images/<?php echo $c['prod_imageone']?>"
                                    alt="java img"></a>
                            <h4><?= $c['prod_name'] ?></h4>
                            <p><?= $c['prod_qty'] ?> items</p>
                        </li>
                        <?php 
            }
            ?>
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="aa-promo-left">
                                ...
                                <div class="aa-promo-banner">
                                    ...
                                    <img src="http://localhost/metalic/admin/banner_images/<?php echo $c['b_image']; ?>"
                                        alt="img">
                                    <?php endforeach; ?>
            ...
            <div class="col-md-12">
              ...
              // echo $row;die;
                 ...
                 foreach($run as $c)
                 {
                  ...
                  ?>
                                <li <?php if($_GET['cat'] == $c['c_name']){ ?> class="active" <?php } ?>>
                                    <a href="index.php?cat=<?= $c['c_name']; ?>"><?= $c['c_name']; ?></a>
                                </li>
                                <?php
                 }
                   ?>
                          ...
                          if($_GET['cat']!=''){
                            $cat=$_GET['cat'];
                            $qry="SELECT * FROM `m_product` LEFT JOIN m_categories ON prod_cat_id=c_id WHERE `prod_status`='Active' and c_name='$cat' order by prod_id desc ";
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="http://localhost/metalic/admin/product_images/<?php echo $c['prod_imageone']?>"
                                                        alt=" shirt img" style="width: 100%;"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                                    <h4 class="aa-product-title"><a href="#"><?= $c['prod_name']; ?></a>
                                                    </h4>
                                                    <span class="aa-product-price"><?= $c['prod_price']  ?></span>
                                                    <span class="aa-product-price"><del><?= $c['prod_aprice']  ?></del>
                                                    </span>
                                          ...
                                          if ($_SESSION['cust_id'] == "") {
                                            ?>
                                                <button><span class="fa fa-heart-o" data-toggle="modal"
                                                        data-target="#signin-signup"></span>
                                                </button>
                                                <?php
                                          }else{
                                            ?>
                                             <button type="button" onclick="myFunction('<?php  echo $c['prod_id'] ?>')" ><span class="fa fa-heart-o"></span>
                                                </button>
                                            <?php
                                          } ?>
                                ...
                                <div class="tab-pane fade" id="women">
                                    <ul class="aa-product-catg">
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/garbage-bags.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                                <figcaption style="padding: 5px;">
                                                    <h4 class="aa-product-title"><a href="#">This is Title</a></h4>
                                                    <span class="aa-product-price">$45.50</span><span
                                                        class="aa-product-price"><del>$65.50</del></span>
                                                    <button type="button"
                                                        class="btn btn-warning btn-sm btn-rounded text-center">Buy
                                                        Now</button>
                                                </figcaption>
                                            </figure>
                                            <div class="aa-product-hvr-content">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/hair-removal-cream.png" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/whisper.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/hair-color.jpeg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/toilet-paper.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/handwash.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/razor-blades.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img src="assets/img/soap.jpg"
                                                        alt=" shirt img" style="width: 100%;"></a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                        class="fa fa-shopping-cart text-center"></span>Add To Cart</a>
                                                <figcaption style="padding: 5px;">
                                ...
                                <div class="tab-pane fade" id="sports">
                                    <ul class="aa-product-catg">
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/chilli-powder.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/coffee.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/mustard_oil.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/olive-oil.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/soyabean-oil.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/tomato-ketchup.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/turmeric-powder.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/vinegar.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                ...
                                <div class="tab-pane fade" id="electronics">
                                    <ul class="aa-product-catg">
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#">
                                                    <img src="assets/img/moong-dal.jpg" alt=" shirt img"
                                                        style="width: 100%;">
                                                </a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="assets/img/electronics/electronic-2.png"
                                                        alt=" shirt img"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                                    <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="assets/img/electronics/electronic-3.png"
                                                        alt=" shirt img"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption style="padding: 5px;">
                                                    <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="assets/img/electronics/electronic-4.png"
                                                        alt=" shirt img"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="assets/img/electronics/electronic-5.png"
                                                        alt=" shirt img"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="assets/img/electronics/electronic-6.png"
                                                        alt=" shirt img"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="assets/img/electronics/electronic-7.png"
                                                        alt=" shirt img"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img
                                                        src="assets/img/electronics/electronic-8.png"
                                                        alt=" shirt img"></a>
                                                <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                                                ...
                                                                <div class="simpleLens-big-image-container">
                                                                    <a class="simpleLens-lens-image"
                                                                        ...
                                                                        <img src="assets/img/view-slider/medium/polo-shirt-1.png"
                                                                            class="simpleLens-big-image" alt="img">
                                                                    </a>
                                                                </div>
                                                            </div>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="aa-banner-area">
                        <?php  
             foreach($run2 as $c): ?>
                        <a href="#"><img src="http://localhost/metalic/admin/banner_images/<?php echo $c['b_image']; ?>"
                                alt="fashion banner img" style="width: 100%;"></a>
...
<section id="aa-popular-category" class="product-featured-slider">
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="aa-popular-category-area">
                        <ul class="nav nav-tabs aa-products-tab">
                            <li <?php if($_GET['type']=='POPULAR' || $_GET['type']==''){ ?> class="active" <?php  } ?>>
                                <a href="index.php?type=POPULAR">Popular</a></li>
                            <li <?php if($_GET['type']=='FEATURED'){ ?> class="active" <?php  } ?>><a
                                    href="index.php?type=FEATURED">Featured</a></li>
                            <li <?php if($_GET['type']=='LATEST'){ ?> class="active" <?php  } ?>><a
                                    href="index.php?type=LATEST">Latest</a></li>
                        </ul>
                        <div class="tab-content">
        ...
        $type = $_GET['type'];
        if($_GET['type']!=''){
          $qry = "SELECT * FROM `m_product` LEFT JOIN m_categories ON prod_cat_id=c_id WHERE `prod_status`='Active' and `prod_type`='$type' order by prod_id desc ";
        }else{
          $qry = "SELECT * FROM `m_product` LEFT JOIN m_categories ON prod_cat_id=c_id WHERE `prod_status`='Active' and `prod_type`='POPULAR' order by prod_id desc ";
        }
          // echo $qry;die;
          ...
          ?>
                            ...
                            <div class="tab-pane fade" id="featured">
                                <ul class="aa-product-catg aa-popular-slider">
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="#"><img src="assets/img/organics1.png"
                                                    alt="img"></a>
                                            <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                            <figcaption>
                                                <h4 class="aa-product-title"><a href="#">Polo Lorem ipsum doller</a>
                                                </h4>
                                                <span class="aa-product-price">$45.50</span>
                                    ...
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="#"><img src="assets/img/organics2.png"
                                                    alt="img"></a>
                                            <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                            <figcaption>
                                    ...
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="#"><img src="assets/img/organics3.png"
                                                    alt="img"></a>
                                            <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                        </figure>
                                        <figcaption>
                                            ...
                                            <span class="aa-product-price">$45.50</span>
                                            <button type="button"
                                                class="btn btn-warning btn-sm btn-rounded text-center">Buy Now</button>
                                        </figcaption>
                                        <div class="aa-product-hvr-content">
                                            <a href="#" data-toggle="tooltip" data-placement="top"
                                                title="Add to Wishlist">
                                    ...
                                    <li>
                                        <figure>
                                            <a class="aa-product-img" href="#"><img src="assets/img/organics4.png"
                                                    alt="img"></a>
                                            <!-- <a class="aa-add-card-btn" href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a> -->
                                            <figcaption>
                                                <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
